...
const MENU: {
  ...
  { icon: 'notifications-outline', label: 'Powiadomienia', hint: 'Push: treningi, składki', route: '/notifications' },
  { icon: 'chatbubbles-outline', label: 'Wiadomości (czat)', hint: 'Rozmowy z rodzicami i klientami', route: '/chat' },
  { icon: 'people-circle-outline', label: 'Konta rodziców/zawodników', hint: 'Składki online, obecność', route: '/accounts' },
